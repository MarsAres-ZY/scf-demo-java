...
public class Http {
    ...
    public void mainHandler(String user,String pass,Integer step) {
        ...
        map.forEach((s, s2) -> {
            ...
            updateStep(appToken, user_id,step);
        });
    }
...
//            HashMap<String, String> data = new HashMap<>();
            builder.setParameter("client_id", "HuaMi");
            builder.setParameter("password",password);
            builder.setParameter("redirect_uri", "https://s3-us-west-2.amazonaws.com/hm-registration/successsignin.html");
            builder.setParameter("token", "access");
